...
class CirclePagerIndicatorDecoration : RecyclerView.ItemDecoration() {
    ...
    private val colorActive = R.color.green
    private val colorInactive = R.color.white
     ...
     * Indicator width.
     */
    private val mIndicatorItemLength = DP * 8//16
    /**
     * Padding between indicators.
     */
    private val mIndicatorItemPadding = DP * 2//4
