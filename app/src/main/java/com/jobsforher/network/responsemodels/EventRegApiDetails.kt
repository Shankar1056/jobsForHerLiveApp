...
class EventRegApiDetails {
    ...
    @SerializedName("body")
    @Expose
    var body: EventRegDetailsBody? = null
    @SerializedName("pagination")
    @Expose
    var pagination: Pagination? = null

}
class EventRegDetailsBody{
    ...
    @SerializedName("registerred_event_locations")
    @Expose
    var events_locations: EventLocations? = null
    @SerializedName("events_images")
    @Expose
    var events_images: List<EventImages>? = null
