...
class MyEvent {
    ...
    @SerializedName("body")
    @Expose
    var body: List<MyEventBody>? = null
...
class MyEventBody{
    ...
    @Expose
    var event_location_id: Int? = null
    ...
    @SerializedName("events_mapping_id")
    @Expose
    var events_mapping_id: Int? = null
    ...
    @Expose
    var register_status: String? = null
    @SerializedName("user_text")
    @Expose
    var user_text: String? = null
    @SerializedName("events")
    @Expose
    var events: EventBody1? = null
...
//    "events_images": [],
    ...
    @Expose
    var link_companies_name: List<Company_Event>? = null
