...
class GroupCommentsNew {
    ...
    @SerializedName("body")
    @Expose
    var body: ArrayList<GroupCommentsBodyNew>? = null
...
class GroupCommentsBodyNew(
    ...
    var replyModel: ArrayList<GroupCommentReplyBodyNew> = ArrayList<GroupCommentReplyBodyNew>()
...
@Parcelize
data class GroupCommentReplyBodyNew(
