...
class ZSplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.zsplasha_activity)
        ...
        val myThread = object : Thread() {
            override fun run() {
                try {
                    Thread.sleep(1200)
                    val intent = Intent(applicationContext, com.jobsforher.activities.ZSplashActivityNew::class.java)
