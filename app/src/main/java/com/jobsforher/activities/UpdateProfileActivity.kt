...
import kotlinx.android.synthetic.main.activity_update_profile_pic.*
...
public var profilePicturePathUpdate:String? = ""
public var profileImageEncodedUpdate = "";
...
//                    startActivity(intent)
                    ...
                    ToastHelper.makeToast(applicationContext, "Update Success")
                    setResult(1);
                    finish()
