...
public class PayUMoneyActivity extends AppCompatActivity {
    ...
    */
    ...
    // Final Variables
    private String mMerchantKey = "gtKFFx"; //"Your Merchant Key";
    private String mSalt = "eCwWELxi"; //"Salt";
    private String mBaseURL = "https://test.payu.in" ; //"https://secure.payu.in";
...
//            mTXNId = bundle.getString("txnid");
//            mHash = bundle.getString("hash");
            //isFromOrder = bundle.getBoolean("isFromOrder");

            Log.i("TAGG", "" + mFirstName + " : " + mEmailId + " : " + mAmount + " : " + mPhone);
...
//                        getIntent().putExtra("transaction_id", mTXNId);
//                        getIntent().putExtra("id", mId);
//                        getIntent().putExtra("isFromOrder", isFromOrder);
...
//                        //Intent intent = new Intent(PayUMoneyActivity.this, PaymentStatusActivity.class);
//                        getIntent().putExtra("status", false);
//                        getIntent().putExtra("transaction_id", mTXNId);
//                        getIntent().putExtra("id", mId);
//                        getIntent().putExtra("isFromOrder", isFromOrder);
//                        getIntent().addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
...
//                    }
    ...
    public void webViewClientPost(WebView webView, String url,
        ...
        Log.d("TAGG", "webViewClientPost called: " + sb.toString());
...
//        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    public class PayUJavaScriptInterface {
        ...
        @JavascriptInterface
        public void success(long id, final String paymentId, String status) {
            mHandler.post(new Runnable() {

                public void run() {
                    mHandler = null;
                    Log.d("TAGG", paymentId);
