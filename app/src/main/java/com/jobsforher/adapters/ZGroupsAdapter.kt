...
class ZGroupsAdapter(private val mDataList: ArrayList<Groups>) : RecyclerView.Adapter<ZGroupsAdapter.MyViewHolder>() {

    private var context: Context? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.zgroups_adapter_row, parent, false)
