...
import com.jobsforher.network.responsemodels.CreateCommentResponse
...
class PostsAdapter(private val mDataList: ArrayList<GroupsPostModel>, val isLoggedIn: Boolean) : RecyclerView.Adapter<PostsAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.posts_adapter_row, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        // Linkify.addLinks(holder.row_description,Linkify.ALL)
        holder.row_upvote.text= mDataList[position].upvote_count
        holder.row_downvote.text= mDataList[position].downvote_count
...
//            "http://www3.nd.edu/~cpoellab/teaching/cse40816/android_tutorial.pdf"
        ...
        if (mDataList[position].comments_count.toString().equals("0")){
            ...
            Log.d("TAGG","ADAPTER coment"+mDataList[position].comment_list?.entity_value)
            ...
            holder.comment_data.setText(mDataList[position].comment_list?.entity_value?.let {
                HtmlCompat.fromHtml(
            ...
            if (mDataList[position].comment_list != null){
                if(mDataList[position].comment_list?.profile_icon != null && mDataList[position].comment_list?.profile_icon!!.isNotEmpty()) {
                    Picasso.with(context)
...
//        })
        ...
        holder.send_comment.setOnClickListener {
            if (holder.row_comment_edittext.text.trim().toString().length>1) {
        ...
        holder.comment_upvote_block.setOnClickListener {
            if (holder.status_Textview_comments.text.equals("none")||holder.status_Textview_comments.text.equals("downvote")) {
        ...
        holder.comment_downvote_block.setOnClickListener {
            if (holder.status_Textview_comments.text.equals("none") || holder.status_Textview_comments.text.equals("vote")) {
        ...
        holder.shareblock.setOnClickListener {
            (context as ZActivityGroupsDetails).sharepostdetails(mDataList[position].id!!)
...
//        }
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            comment_upvote_block= itemView.findViewById<View>(R.id.comment_upvote_block) as LinearLayout
            comment_downvote_block= itemView.findViewById<View>(R.id.comment_downvote_block) as LinearLayout
            comment_replies_block= itemView.findViewById<View>(R.id.comment_replies_block) as LinearLayout
            ...
            status_Textview_comments = itemView.findViewById<View>(R.id.status_textview_comments) as TextView
    ...
    private fun addComment(entity_type: String, entity_value:String, id:Int,holder: MyViewHolder, position: Int){
...
//                        mDataList[position].comment_list!!.parent_id = jsonaobj.getString("parent_id")
                        ...
                        mDataList[position].comment_list!!.created_by = jsonaobj.getString("created_by")
                        mDataList[position].comment_list!!.upvote_count = jsonaobj.getString("upvote_count")
                        mDataList[position].comment_list!!.downvote_count = jsonaobj.getString("downvote_count")
                        mDataList[position].comment_list!!.url = jsonaobj.getString("url")
                        mDataList[position].comment_list!!.hash_tags = jsonaobj.getString("hash_tags")
                        ...
                        mDataList[position].comment_list!!.created_on = jsonaobj.getString("created_on")
                        mDataList[position].comment_list!!.modified_on = jsonaobj.getString("modified_on")
                        mDataList[position].comment_list!!.created_on_str = jsonaobj.getString("created_on_str")
...
//                        mDataList[position].comment_list!!.replies_count = jsonaobj.getString("replies_count")
                        mDataList[position].comment_list!!.aggregate_count = jsonaobj.getString("aggregate_count")
                        ...
                        mDataList[position].comment_list!!.profile_icon = jsonaobj.getString("profile_icon")
...
//                        holder.comment_edittext.setText("0")
    ...
    private fun checkReportPost(pos:Int){
        ...
        val call = retrofitInterface!!.ReportCheckPost(mDataList[pos].id,EndPoints.CLIENT_ID, "Bearer "+EndPoints.ACCESS_TOKEN)
        ...
        call.enqueue(object : Callback<DeletePostResponse> {
            override fun onResponse(call: Call<DeletePostResponse>, response: Response<DeletePostResponse>) {
                ...
                if (response.isSuccessful && response.body()!!.responseCode.toString().equals("10802") ) {      //11804
                    ...
                    (context as ZActivityGroupsDetails).openBottomSheet(mDataList[pos].edited,mDataList[pos].id, mDataList[pos].description,
                        mDataList[pos].is_owner!!, mDataList[pos].profile_icon.toString(),mDataList[pos].url.toString(),
                        mDataList[pos].post_type.toString(),"yes")
                } else {

                    (context as ZActivityGroupsDetails).openBottomSheet(mDataList[pos].edited,mDataList[pos].id, mDataList[pos].description,
                        mDataList[pos].is_owner!!, mDataList[pos].profile_icon.toString(),mDataList[pos].url.toString(),
                        mDataList[pos].post_type.toString(),"no")
                }
            }
    ...
    private fun checkReportComment(pos:Int){
        ...
        val call = retrofitInterface!!.ReportCheckComment(mDataList[pos].comment_list!!.id,EndPoints.CLIENT_ID, "Bearer "+EndPoints.ACCESS_TOKEN)
        ...
        call.enqueue(object : Callback<DeletePostResponse> {
            override fun onResponse(call: Call<DeletePostResponse>, response: Response<DeletePostResponse>) {
                ...
                if (response.isSuccessful && response.body()!!.responseCode.toString().equals("10802") ) {      //11804
                    // Toast.makeText(context,"Hello",Toast.LENGTH_LONG).show()
                    (context as ZActivityGroupsDetails).openBottomSheetComments(mDataList[pos].comment_list!!.edited,mDataList[pos].comment_list!!.id, mDataList[pos].comment_list!!.entity_value,
                        mDataList[pos].comment_list!!.is_owner, mDataList[pos].comment_list!!.profile_icon!!.toString(),"yes")
                } else {

                    (context as ZActivityGroupsDetails).openBottomSheetComments(mDataList[pos].comment_list!!.edited,mDataList[pos].comment_list!!.id, mDataList[pos].comment_list!!.entity_value,
                        mDataList[pos].comment_list!!.is_owner, mDataList[pos].comment_list!!.profile_icon!!.toString(),"no")
                }
            }
