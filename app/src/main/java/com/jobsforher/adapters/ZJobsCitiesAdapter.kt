...
class ZJobsCitiesAdapter(private val mDataList: ArrayList<CityView>,val compare:ArrayList<String>) : RecyclerView.Adapter<ZJobsCitiesAdapter.MyViewHolder>() {
        ...
        holder.checkbox.setOnCheckedChangeListener(object : CompoundButton.OnCheckedChangeListener {
            ...
            override fun onCheckedChanged(buttonView: CompoundButton, isChecked: Boolean) {
                ...
                if (hexColor.equals("#000000")) {
                    (context as ZActivityJobs).getSelectedCities(0, mDataList[position].name.toString())
                    holder.name.setTextColor(Color.parseColor("#BEBEBE"))
                    ...
                    (context as ZActivityJobs).getSelectedCities(mDataList[position].id, mDataList[position].name.toString())
                    holder.name.setTextColor(Color.parseColor("#000000"))
