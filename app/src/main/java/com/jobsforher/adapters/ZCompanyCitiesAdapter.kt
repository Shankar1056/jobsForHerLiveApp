...
class ZCompanyCitiesAdapter(private val mDataList: ArrayList<CityView>,val compare:ArrayList<String>) : RecyclerView.Adapter<ZCompanyCitiesAdapter.MyViewHolder>() {
        ...
        holder.checkbox.setOnCheckedChangeListener(object : CompoundButton.OnCheckedChangeListener {
            ...
            override fun onCheckedChanged(buttonView: CompoundButton, isChecked: Boolean) {
                ...
                if (hexColor.equals("#000000")) {
                    (context as ZActivityCompanies).getSelectedCities(0,  mDataList[position].name.toString())
                    holder.name.setTextColor(Color.parseColor("#BEBEBE"))
                    ...
                    (context as ZActivityCompanies).getSelectedCities(mDataList[position].id, mDataList[position].name.toString())
                    holder.name.setTextColor(Color.parseColor("#000000"))
                    holder.bullet.setTextColor(Color.parseColor("#000000"))
                    holder.checkbox.isChecked = true
                    holder.checkbox.setButtonTintList(AppCompatResources.getColorStateList(context!!, R.color.green));
